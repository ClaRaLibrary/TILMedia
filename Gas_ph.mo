...
equation
  ...
  (T, cp, cv, beta, w,xi_s) = TILMedia.Internals.GasObjectFunctions.simpleCondendsingProperties_phxi(p, h, xi, gasPointer);
  ...
  annotation (defaultComponentName="gas", Icon(graphics={Bitmap(extent={{-100,100},{100,-100}},
          imageSource=
