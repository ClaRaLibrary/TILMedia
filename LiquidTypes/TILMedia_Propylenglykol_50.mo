...
record TILMedia_Propylenglykol_50 "TILMedia.Propylenglykol_50 % mass fraction"
  extends TILMedia.LiquidTypes.BaseLiquid(
    ...
    final concatLiquidName="TILMedia.Propylenglykol_50");
end TILMedia_Propylenglykol_50;
