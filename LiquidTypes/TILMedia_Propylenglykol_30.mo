...
record TILMedia_Propylenglykol_30 "TILMedia.Propylenglykol_30 % mass fraction"
  extends TILMedia.LiquidTypes.BaseLiquid(
    ...
    final concatLiquidName="TILMedia.Propylenglykol_30");
end TILMedia_Propylenglykol_30;
