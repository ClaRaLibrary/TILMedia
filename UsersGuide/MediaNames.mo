...
<table border=1>
   ...
   <tr>
    ...
    <td>Medium must end with _lambdavalue e.g. _1.2 &nbsp; </td>
  </tr>
   <tr>
    <td> &nbsp; </td>
    <td> &nbsp; </td>
...
All 2024 media names by NASA Glenn Coefficients can be received on demand.
<br><br>
<!-- NASA medium names with brackets to not function in this version. They can nevertheless be added at any time if necessary.<br> -->
