...
equation
  ...
  (d,s_dummy,kappa,drhodp_hxi,drhodh_pxi,drhodxi_ph,p_i,xi_gas) = TILMedia.Internals.GasObjectFunctions.additionalProperties_pTxi(p,T,xi,gasPointer);
  ...
  annotation (defaultComponentName="gas", Icon(graphics={
          ...
          fileName="modelica://TILMedia/Images/Gas_ps.png")}),
                   ...
                   <p>
                   The gas model Gas_ps calculates the thermopyhsical property data with given inputs: pressure (p), entropy (s), massfraction (xi) and the parameter gasType.<br>
