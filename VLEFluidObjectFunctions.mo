...
package VLEFluidObjectFunctions
  ...
  class VLEFluidPointer
     ...
     function constructor "get memory"
      ...
      external "C" vleFluidPointer = TILMedia_VLEFluid_createExternalObject(vleFluidName, flags, xi, nc_propertyCalculation, nc) annotation(Library="TILMedia112ClaRa");
     end constructor;

     function destructor "free memory"
      input VLEFluidPointer vleFluidPointer;
      external "C" TILMedia_VLEFluid_destroyExternalObject(vleFluidPointer) annotation(Library="TILMedia112ClaRa");
     end destructor;
  end VLEFluidPointer;
