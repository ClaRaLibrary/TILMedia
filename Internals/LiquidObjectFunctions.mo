...
package LiquidObjectFunctions
  ...
  external "C" mm=  TILMedia_Liquid_molarMass_xi(mediumPointer,xi) annotation(Library="TILMedia112ClaRa");
  ...
  function specificEnthalpy_Txi
    ...
    annotation(Library="TILMedia112ClaRa", inverse(T=temperature_hxi(h,xi,liquidPointer)));
  ...
  external "C" s=  TILMedia_Liquid_specificEntropy_pTxi(p,T,xi,mediumPointer) annotation(Library="TILMedia112ClaRa");
  annotation(Impure=false);
  ...
  function temperature_hxi
    ...
    annotation(Library="TILMedia112ClaRa", inverse(h=specificEnthalpy_Txi(T,xi,liquidPointer)));
  end temperature_hxi;
  ...
  external "C" TILMedia_Liquid_transportProperties_Txi(T,xi,mediumPointer,transp.Pr,transp.lambda,transp.eta,transp.sigma) annotation(Library="TILMedia112ClaRa");
  annotation(Impure=false);
