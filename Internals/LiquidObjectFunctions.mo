...
package LiquidObjectFunctions
  ...
  external "C" mm=  TILMedia_Liquid_molarMass_xi(mediumPointer,xi) 
    annotation(__iti_dllNoExport = true,Include="double TILMedia_Liquid_molarMass_xi(double*,void*);",Library="TILMedia130ClaRa");
  ...
  function properties_hxi
    ...
    external "C" TILMedia_Liquid_properties_hxi(h,xi,mediumPointer,d,cp,beta)
      annotation(__iti_dllNoExport = true,Include="void TILMedia_Liquid_properties_hxi(double, double*, void*, double*, double*, double*);",Library="TILMedia130ClaRa");
      annotation(Impure=false);
  end properties_hxi;
  ...
  function properties_Txi
    ...
    external "C" TILMedia_Liquid_properties_Txi(T,xi,mediumPointer,d,cp,beta)
      annotation(__iti_dllNoExport = true,Include="void TILMedia_Liquid_properties_Txi(double, double*, void*, double*, double*, double*);",Library="TILMedia130ClaRa");
      annotation(Impure=false);
  end properties_Txi;
  ...
  function specificEnthalpy_Txi
    ...
    external "C" h=  TILMedia_LiquidObjectFunctions_specificEnthalpy_Txi(T, xi, liquidPointer)
      annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidObjectFunctions_specificEnthalpy_Txi(double, double*, void*);",Library="TILMedia130ClaRa", inverse(T=temperature_hxi(h,xi,liquidPointer)));
  ...
  external "C" s=  TILMedia_Liquid_specificEntropy_pTxi(p,T,xi,mediumPointer) 
    annotation(__iti_dllNoExport = true,Include="double TILMedia_Liquid_specificEntropy_pTxi(double, double, double*, void*);",Library="TILMedia130ClaRa");
    annotation(Impure=false);
  ...
  function temperature_hxi
    ...
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidObjectFunctions_temperature_hxi(double, double*, void*);",Library="TILMedia130ClaRa", inverse(h=specificEnthalpy_Txi(T,xi,liquidPointer)));
  end temperature_hxi;
  ...
  annotation(__iti_dllNoExport = true,Include="void TILMedia_Liquid_transportProperties_Txi(double, double*, void*, double*, double*, double*, double*);",Library="TILMedia130ClaRa");
  annotation(Impure=false);
