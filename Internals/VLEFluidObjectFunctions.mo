...
package VLEFluidObjectFunctions
  ...
  external "C" TILMedia_VLEFluid_criticalDataRecord_xi(xi, vleFluidPointer,d,h,p,s,T) annotation(Library="TILMedia110ClaRa");
                                                                                                        annotation(Impure=false);
  ...
  external "C" mm=  TILMedia_VLEFluid_Cached_molarMass_xi(xi, vleFluidPointer) annotation(Library="TILMedia110ClaRa");
                                                                                                        annotation(Impure=false);
  end molarMass_xi;
  ...
  external "C" isValid=  TILMedia_VLEFluid_isValid(mediumName) annotation(Library="TILMedia110ClaRa");
                                                                                                 annotation(Impure=false);
  end fluidIsValid;
  ...
  external "C" TILMedia_VLEFluid_Cached_molarMass(vleFluidPointer, mm_i) annotation(Library="TILMedia110ClaRa");
                                                                                                        annotation(Impure=false);
  end molarMass_nc;
  ...
  external "C" p_triple=  TILMedia_VLEFluid_Cached_triplePressure_n(compNo, vleFluidPointer) annotation(Library="TILMedia110ClaRa");
                                                                                                        annotation(Impure=false);
  ...
  external "C" T_triple=  TILMedia_VLEFluid_Cached_tripleTemperature_n(compNo, vleFluidPointer) annotation(Library="TILMedia110ClaRa");
                                                                                                        annotation(Impure=false);
  ...
  function cricondenbar_xi
    ...
    input TILMedia.VLEFluidObjectFunctions.VLEFluidPointer
                       vleFluidPointer;
    output Real d,h,p,s,T;
  external "C" TILMedia_VLEFluid_cricondenbar_xi(xi, vleFluidPointer,d,h,p,s,T) annotation(Library="TILMedia110ClaRa");
                                                                                                        annotation(Impure=false);
  end cricondenbar_xi;
  ...
  function cricondentherm_xi
    ...
    input TILMedia.VLEFluidObjectFunctions.VLEFluidPointer
                       vleFluidPointer;
    output Real d,h,p,s,T;
  external "C" TILMedia_VLEFluid_cricondentherm_xi(xi, vleFluidPointer,d,h,p,s,T) annotation(Library="TILMedia110ClaRa");
                                                                                                        annotation(Impure=false);
