...
package LiquidFunctions
  ...
  external "C" s = TILMedia_LiquidFunctions_specificEntropy_phxi(p, h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_specificEntropy_phxi(double, double, double*,const char*, int);",Library="TILMedia130ClaRa");
  ...
  external "C" s = TILMedia_LiquidFunctions_specificEntropy_pTxi(p, T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_specificEntropy_pTxi(double, double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" d = TILMedia_LiquidFunctions_density_Txi(T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_density_Txi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  end density_Txi;
  ...
  external "C" h = TILMedia_LiquidFunctions_specificEnthalpy_Txi(T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_specificEnthalpy_Txi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" p = TILMedia_LiquidFunctions_pressure_Txi(T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_pressure_Txi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  end pressure_Txi;
  ...
  external "C" cp = TILMedia_LiquidFunctions_specificIsobaricHeatCapacity_Txi(T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_specificIsobaricHeatCapacity_Txi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" beta = TILMedia_LiquidFunctions_isobaricThermalExpansionCoefficient_Txi(T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_isobaricThermalExpansionCoefficient_Txi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" Pr = TILMedia_LiquidFunctions_prandtlNumber_Txi(T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_prandtlNumber_Txi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" lambda = TILMedia_LiquidFunctions_thermalConductivity_Txi(T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_thermalConductivity_Txi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" eta = TILMedia_LiquidFunctions_dynamicViscosity_Txi(T, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_dynamicViscosity_Txi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" d = TILMedia_LiquidFunctions_density_hxi(h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_density_hxi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  end density_hxi;
  ...
  external "C" p = TILMedia_LiquidFunctions_pressure_hxi(h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_pressure_hxi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  end pressure_hxi;
  ...
  external "C" T = TILMedia_LiquidFunctions_temperature_hxi(h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_temperature_hxi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  end temperature_hxi;
  ...
  external "C" cp = TILMedia_LiquidFunctions_specificIsobaricHeatCapacity_hxi(h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_specificIsobaricHeatCapacity_hxi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" beta = TILMedia_LiquidFunctions_isobaricThermalExpansionCoefficient_hxi(h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_isobaricThermalExpansionCoefficient_hxi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" Pr = TILMedia_LiquidFunctions_prandtlNumber_hxi(h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_prandtlNumber_hxi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" lambda = TILMedia_LiquidFunctions_thermalConductivity_hxi(h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_thermalConductivity_hxi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
  ...
  external "C" eta = TILMedia_LiquidFunctions_dynamicViscosity_hxi(h, xi, liquidName, nc)
    annotation(__iti_dllNoExport = true,Include="double TILMedia_LiquidFunctions_dynamicViscosity_hxi(double, double*,const char*, int);",Library="TILMedia130ClaRa");
    annotation (Icon(graphics={Bitmap(extent={{-100,-100},{100,100}}, fileName="modelica://TILMedia/Images/Liquid_Function.png")}));
